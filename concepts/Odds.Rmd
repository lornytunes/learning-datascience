...
![Odds as p/1-p](../images/odds_4.png)
...
This can be answered by comparing the odds. If they have the mutated gene are the odds higher that they will get cancer.

The odds of having cancer given the mutated gene are

```{r odds_ratio_compare}
